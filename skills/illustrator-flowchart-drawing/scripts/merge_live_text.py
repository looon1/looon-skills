...
def main() -> int:
    parser = argparse.ArgumentParser(description="Merge live text into a Illustrator流程图绘制 Master SVG.")
    ...
    root.set("data-illustrator-flowchart-text-manifest", manifest_path.name)
